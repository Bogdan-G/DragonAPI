...
public class ReikaThaumHelper {
	...
	public static void addInfusionRecipeBookEntryViaXML(String id, String desc, String category, InfusionRecipe ir, int row, int col, Class root, String path) {
		...
		XMLResearch xml = new XMLResearch(id.toLowerCase(java.util.Locale.ENGLISH), root, path, ir, 2);
	...
	public static class XMLResearch {
		...
		private class XMLPage extends ResearchPage {
			...
			public String getTranslatedText() {
				return info.getValueAtNode("researches:"+name.toLowerCase(java.util.Locale.ENGLISH)+":page"+page);
			}
	...
	public static int[] aspectToIntsForPacket(Aspect a) {
		String s = a.getName().toLowerCase(java.util.Locale.ENGLISH);
